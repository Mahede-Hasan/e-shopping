...
const TrendyCard = ({card}) => {
    const {img, name, brand, price, oldPrice} = card;
    return (
        <div data-aos="fade-up"
        data-aos-duration="3000"  className='mx-auto lg:w-[200px] lg:h-[350px] md:w-[200px] md:h-[350px] sm:w-[140px] sm:h-[280px] cursor-pointer  hover:shadow-lg hover:shadow-gray-200/50 mb-6 '>
            <div>
                {/* Card Image */}
